                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('evenements.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="elements_requis" id="elements_requis" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        </div>
                        <div class="mb-4">
                            <label for="nb_place" class="block text-gray-700 text-sm font-bold mb-2">Nombre de places :</label>
                            <input type="number" name="nb_place" id="nb_place" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        </div>
                        <div class="mb-4">
