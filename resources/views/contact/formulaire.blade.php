                ...
                <div class="p-6 lg:p-8">
                    ...
                    <form method="POST" action="{{ route('contact.submit') }}" class="mt-8 space-y-6">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="message" name="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Votre message ici..." required>{{ old('message') }}</textarea>
                        </div>
